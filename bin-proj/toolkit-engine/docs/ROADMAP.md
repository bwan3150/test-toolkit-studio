...
- **skill 集成**（设计稿已落 `docs/skill-integration.md` + ADR-0009 提案）:让 Claude Code 等
  coding agent 调 tke 做 UI 验收。首版 Web+Android;起步阶段 0(零改动包 `tke run`),
  阶段 1 才动 headless。**ADR-0009 待用户拍板后才开工**
