...
| [`platform-integration`](adr/0023-platform-integration.md) | **与测试管理平台（test-system/platform）对接**：平台是客户端、执行分两层对应计费、tke 侧只补 `usage` 口子。平台侧设计在 `platform/docs/11_device_cloud.md` + `12_security_entity.md` |
